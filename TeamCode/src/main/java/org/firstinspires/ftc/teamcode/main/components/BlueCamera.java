...
@Singleton
public class BlueCamera extends Component {
    public final BlueObjectPipeline pipeline;
    private final OpenCvWebcam webcam;
    private final Telemetry telemetry;

    @Inject
    public BlueCamera(HardwareMap hardwareMap, Telemetry telemetry) {
    ...
    public class BlueObjectPipeline extends OpenCvPipeline {
        private final Scalar LOWER_YELLOW = new Scalar(110, 50, 50); // HSV lower bound for yellow
        private final Scalar UPPER_YELLOW = new Scalar(130, 255, 255); // HSV upper bound for yellow
